...
import { ChevronsRight, ChevronsLeft, Terminal, FilePenLine } from "lucide-react";
...
export function RightSidebar() {
  const [collapsed, setCollapsed] = useState(() =>
    loadInitial(STORAGE_COLLAPSED, false, (s) => s === "1")
  );
  ...
  if (collapsed) {
    return (
      <aside
        className="relative flex h-full flex-col border-l border-border bg-muted/20"
