...
interface DashboardStore {
  ...
  // Static mode: embedded source content (filePath → { language, content, lineCount, sizeBytes })
  sourceContent: Record<string, { language: string; content: string; lineCount: number; sizeBytes: number }> | null;
  setSourceContent: (content: Record<string, { language: string; content: string; lineCount: number; sizeBytes: number }> | null) => void;
}
